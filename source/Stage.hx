				...
				case 'studioLot':
					{
						camZoom = 0.9;
						curStage = 'studioLot';
						var bg:FlxSprite = new FlxSprite(-200, -400).loadGraphic(Paths.image('studioLot/sky'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						...
						mountainback.antialiasing = FlxG.save.data.antialiasing;
						...
						moutainsfoward.antialiasing = FlxG.save.data.antialiasing;
						...
						studio.updateHitbox();
						studio.antialiasing = FlxG.save.data.antialiasing;
